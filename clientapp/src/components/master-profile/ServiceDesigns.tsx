          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <Badge 
                  variant={serviceDesign.nailDesign.type === 'designer' ? 'default' : 'secondary'}
                  className="text-xs"
                >
                  {serviceDesign.nailDesign.type === 'designer' ? 'Дизайнерский' : 'Базовый'}
                </Badge>
                
                <span className="text-sm font-semibold text-primary">
                  {serviceDesign.customPrice ? `${serviceDesign.customPrice}₽` : 'В цене услуги'}
                </span>
              </div>
